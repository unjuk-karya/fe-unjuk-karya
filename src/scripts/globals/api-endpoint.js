...
const API_ENDPOINT = {
  ...
  POST_LIKES: (postId) => `${CONFIG.BASE_URL}posts/${postId}/likes`, // POST
  GET_POST_LIKES: (postId, page = 1, pageSize = 5) =>
    `${CONFIG.BASE_URL}posts/${postId}/likes?page=${page}&pageSize=${pageSize}`, // GET
